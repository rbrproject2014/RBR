...
public class SidebarPageConfigChapter4Impl implements SidebarPageConfig {
	...
	public SidebarPageConfigChapter4Impl(){		
		pageMap.put("fn1",new SidebarPage("zk","Add/Update Race Information","/imgs/site.png","//chapter6/index.zul"));
		pageMap.put("fn2",new SidebarPage("demo","Enter Chit Details","/imgs/demo.png","//chapter6/indexChit.zul"));
